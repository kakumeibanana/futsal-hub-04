...
export const newsItems: NewsItem[] = [
  { id: "1", date: "2026-03-23", title: "春季大会の組み合わせが決定しました", content: "3月28日より開催される春季大会の組み合わせが発表されました。初戦の相手は南高校です。応援よろしくお願いします！", category: "大会", visibility: "public" },
  { id: "2", date: "2026-03-20", title: "新入部員募集のお知らせ", content: "4月より新入部員を募集します。フットサル経験の有無は問いません。興味のある方はぜひ体験に来てください。", category: "募集", visibility: "public" },
  { id: "3", date: "2026-03-15", title: "練習試合の結果報告", content: "3月15日に行われた北高校との練習試合は 4-2 で勝利しました。チーム全体の守備が安定していました。", category: "試合結果", visibility: "member" },
  { id: "4", date: "2026-03-10", title: "ユニフォーム注文について", content: "新ユニフォームの注文を受け付けています。希望者は3月25日までに顧問の先生に申し込んでください。", category: "連絡", visibility: "member" },
];
